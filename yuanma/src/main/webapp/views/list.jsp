...
<!-- ------------------------------------------------------------------------------------------------------------------- -->
				 ...
				 <div class="col-md-9"> 
					<div class="container">
						...
						<div class="input-group col-md-3" style="margin-top:0px positon:relative">  
      			 			<input type="text" class="form-control" id="empSearch_input" placeholder="请输入字段名"/ >  
            					<span class="input-group-btn"><button class="btn btn-primary empSearch_btn">查找</button></span>
 						</div> 
 						
                		<!-- 新增，删除按钮 -->
						<div class="col-md-6 col-md-offset-9" id="save_del_btn">
							<button class="btn btn-primary" id="emp_add_btn">新增</button>
							<button class="btn btn-danger" id="emp_delete_all_btn">删除</button>
							<button class="btn btn-success" id="exportExcel">导出excel</button>
						</div>
					</div>
		...
		<div class="row">
			...
			<!-- 分页文字信息 -->
			<div class="col-md-5 col-md-offset-3" id="page_info_area"></div>
...
<script type="text/javascript">
        ...
        $("#exportExcel").click(function () {
			window.location.href = "${APP_PATH}/export";
		});
        
    	//模糊查询
		$(".empSearch_btn").click(function(){
			//获取搜索信息
			var searchData = "";
			searchData = $("#empSearch_input").val();
			//alert("您想搜索："+searchData);
			//判断查询条件是否为空
			if(searchData.length > 0){
				//发送ajax请求获取满足条件的数据
				$.ajax({
					url:"${APP_PATH}/search/"+searchData,
					type:"GET",
					success:function(result){ 
						//alert(result.msg);
						//1.解析并显示员工数据
